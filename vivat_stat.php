<?php
    ...
    $queryCandidates = "SELECT candidate, count(*) as number FROM vivat_tvirtinimas GROUP BY candidate;";
    $queryOptions = "SELECT options, count(*) as numberOpt FROM vivat_tvirtinimas GROUP BY options;";
    $queryOptions1 = "SELECT options1, count(*) as numberOpt1 FROM vivat_tvirtinimas GROUP BY options1;";
    $queryRating = "SELECT AVG(rating) AS avgRtg FROM vivat_tvirtinimas;";
    $queryCouncil = "SELECT council, count(*) as numberCnc FROM vivat_council GROUP BY council;";
    $queryDelegate = "SELECT delegate, count(*) as numberDlg FROM vivat_delegate GROUP BY delegate;";
    $queryUsers = "SELECT user, count(*) as numberUsr FROM vivat_tvirtinimas;";
...
<html>
        ...
        <div>
            ...
            <script type="text/javascript">
                ...
                function drawChart() {
                    ...
                    var optionsOpt1 = {
                        title: 'Tvirtinamų narių sąrašas',
                        'width':1000,
                        'height':800
                    };
    ...
    <body>
        ...
        <div class="content home" align="center">
            <br> <b>
            <p>Vivat balsavimo rezultatų statistika</p>
            </b>
        </div>
