...
$optionsSQL = "INSERT INTO infosa_tvirtinimas (user, options, candidate, options1, rating) 
               VALUES ('$user', '$options', '$candidate', '$options1', $rating);";

$councilSQL1 = NULL;
if($council1 != NULL) {
    $councilSQL1 = "INSERT INTO infosa_council (user, council) VALUES ('$user', '$council1');";
    mysqli_query($link, $councilSQL1);
}
$councilSQL2 = NULL;
if($council2 != NULL) {
    $councilSQL2 = "INSERT INTO infosa_council (user, council) VALUES ('$user', '$council2');";
    mysqli_query($link, $councilSQL2);
}
$councilSQL3 = NULL;
if($council3 != NULL) {
    $councilSQL3 = "INSERT INTO infosa_council (user, council) VALUES ('$user', '$council3');";
    mysqli_query($link, $councilSQL3);
}
$councilSQL4 = NULL;
if($council4 != NULL) {
    $councilSQL4 = "INSERT INTO infosa_council (user, council) VALUES ('$user', '$council4');";
    mysqli_query($link, $councilSQL4);
}

$delegateSQL1 = NULL;
if($delegate1 != NULL) {
    $delegateSQL1 = "INSERT INTO infosa_delegate (user, delegate) VALUES ('$user', '$delegate1');";
    mysqli_query($link, $delegateSQL1);
}
$delegateSQL2 = NULL;
if($delegate2 != NULL) {
    $delegateSQL2 = "INSERT INTO infosa_delegate (user, delegate) VALUES ('$user', '$delegate2');";
    mysqli_query($link, $delegateSQL2);
}
$delegateSQL3 = NULL;
if($delegate3 != NULL) {
    $delegateSQL3 = "INSERT INTO infosa_delegate (user, delegate) VALUES ('$user', '$delegate3');";
    mysqli_query($link, $delegateSQL3);
}
$delegateSQL4 = NULL;
if($delegate4 != NULL) {
    $delegateSQL4 = "INSERT INTO infosa_delegate (user, delegate) VALUES ('$user', '$delegate4');";
    mysqli_query($link, $delegateSQL4);
}
$delegateSQL5 = NULL;
if($delegate5 != NULL) {
    $delegateSQL5 = "INSERT INTO infosa_delegate (user, delegate) VALUES ('$user', '$delegate5');";
    mysqli_query($link, $delegateSQL5);
}
$delegateSQL6 = NULL;
if($delegate6 != NULL) {
    $delegateSQL6 = "INSERT INTO infosa_delegate (user, delegate) VALUES ('$user', '$delegate6');";
    mysqli_query($link, $delegateSQL6);
}
$delegateSQL7 = NULL;
if($delegate7 != NULL) {
    $delegateSQL7 = "INSERT INTO infosa_delegate (user, delegate) VALUES ('$user', '$delegate7');";
    mysqli_query($link, $delegateSQL7);
}
$delegateSQL8 = NULL;
if($delegate8 != NULL) {
    $delegateSQL8 = "INSERT INTO infosa_delegate (user, delegate) VALUES ('$user', '$delegate8');";
    mysqli_query($link, $delegateSQL8);
}
$delegateSQL9 = NULL;
if($delegate9 != NULL) {
    $delegateSQL9 = "INSERT INTO infosa_delegate (user, delegate) VALUES ('$user', '$delegate9');";
    mysqli_query($link, $delegateSQL9);
}
$delegateSQL10 = NULL;
if($delegate10 != NULL) {
    $delegateSQL10 = "INSERT INTO infosa_delegate (user, delegate) VALUES ('$user', '$delegate10');";
